...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~llIG1KaT#PtZIHzqyfEfiPfuRyh4TCXj81qIkuD0atvnK6gPAvBM ",
// add your Session Id ,session id starts with MALVIN-XD~

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "✦josee xᴅ v2✦",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254717360855",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "✦ᴍjoseeᴄʜ🪀✦",
// add bot owner name
...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*🎉👀 Status Seen by Çhîèf_.kèɴ xᴅ v2🚀🔥✦*",
...
HEART_REACT: process.env.HEART_REACT || "ftrue",
...
DEV: process.env.DEV || "254717360855",
